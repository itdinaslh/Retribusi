...
function loadTable() {
    ...
    $('#tblData').DataTable({
        ...
        columns: [            
            ...
            {
                data: 'driverId',
                render: function (data, type, row) { return "<button type='button' class='btn btn-sm btn-success mr-2 showMe' style='width:100%;' data-href='/transport/driver/edit/?driverId=" + row.driverId + "'> Edit</button>" },
                sortable: false
            }
        ]
    });
